...
```{r}
# Para n=300 con β_conflicto×dcc = 30
n_grande = 300
# parámetros
beta_0 = 350
beta_conflicto = 20
...
# Luego para n=300 con β_conflicto×dcc = 10
# parámetros
beta_0 = 350
beta_conflicto = 20
...
```{r}
#| results: asis
# Crear tabla con stargazer en formato LaTeX para n=300 y β_conflicto×dcc = 30
...
# Crear tabla con stargazer en formato  para n=300 y B_conflicto×dcc = 10
...
#| results: asis
#| label: fig2
#| fig-cap: "Interacción entre conflicto y reciprocidad para $n$ = 300 y $\\beta_{conflicto \\times dcc}$ = 30"
...
Esta dirección contiene el código fuente de este ejercicio, así como los datos utilizados para la simulación y análisis.

De igual manera se puede acceder con el siguiente código QR.
