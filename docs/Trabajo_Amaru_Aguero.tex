...
\begin{table}[H]
\centering
\caption{\label{tab:unnamed-chunk-16}Coeficientes Beta, Efecto Parcial en el Promedio (PEA) y Efecto Parcial Promedio (APE) para los modelos 7.}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{8}{10}\selectfont
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{3.5cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}>{\centering\arraybackslash}p{1.8cm}}
\toprule
...
\multicolumn{10}{l}{\rule{0pt}{1em}*** p < 0.001, ** p < 0.01, * p < 0.05 (significance shown only for β coefficients)}\\
\multicolumn{10}{l}{\rule{0pt}{1em}Standard errors in parentheses}\\
\multicolumn{10}{l}{\rule{0pt}{1em}β = Beta coefficient; PEA = Partial Effect at the Average; APE = Average Partial Effect}\\
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Trabajo_Amaru_Aguero_files/figure-pdf/unnamed-chunk-17-1.pdf}}

}

\caption{Efecto Parcial en el Promedio (PEA) y Efecto Parcial Promedio
(APE) para los modelos 7 de los tres métodos de estimación: Logit,
Probit y Firth. La figura muestra los efectos de tres variables:
Sustancia principal de consumo comparada con alcohol, Número de
retratamientos comparado con ningún retratamiento y Hospitalizaciones
psiquiátricas previas por unidad adicional. Los valores indican el
cambio en la probabilidad de hospitalización psiquiátrica. La línea roja
vertical en cero representa ausencia de efecto.}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{Trabajo_Amaru_Aguero_files/figure-pdf/unnamed-chunk-18-1.pdf}}
\end{center}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{Trabajo_Amaru_Aguero_files/figure-pdf/unnamed-chunk-19-1.pdf}}
\end{center}
